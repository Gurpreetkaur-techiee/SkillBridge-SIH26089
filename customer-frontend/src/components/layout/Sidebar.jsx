...
export function Sidebar({ className = '' }) {
  ...
  return (
    <aside
      className={`w-64 flex flex-col justify-between shrink-0 h-[calc(100vh-5rem)] sticky top-20 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border-r border-slate-200/80 dark:border-slate-800/80 p-4 transition-colors ${className}`}
    >
